...
def main():
    ...
    with open('tableC.csv', "r", encoding='utf-8') as inFile, open('tableMerge.csv', "w", encoding='utf-8') as outFile:
        ...
        for row in csv.DictReader(inFile):
            ...
            year_rel_diff = em.rel_diff(int(float(lYear)), int(float(rYear)))
            year_abs_norm = em.abs_norm(int(float(lYear)), int(float(rYear)))
            month_rel_diff = em.rel_diff(int(float(lMonth)), int(float(rMonth)))
            month_abs_norm = em.abs_norm(int(float(lMonth)), int(float(rMonth)))
            pages_rel_diff = em.rel_diff(int(float(lPages)), int(float(rPages)))
            pages_abs_norm = em.abs_norm(int(float(lPages)), int(float(rPages)))

            writer.writerow({  'title_affine_score': title_affine_score, 'title_lev_dist_score': title_lev_dist_score, 'title_lev_sim_score': title_lev_sim_score, 'title_jaro_score': title_jaro_score, 'title_jaro_winkler_score': title_jaro_winkler_score, 'title_needleman_wunsch_score': title_needleman_wunsch_score, 'title_smith_waterman_score': title_smith_waterman_score, 'title_jaccard_score': title_jaccard_score, 'title_cosine_score': title_cosine_score, 'title_overlap_coeff_score': title_overlap_coeff_score, 'title_dice_score': title_dice_score, 'title_monge_elkan_score': title_monge_elkan_score,  'author_lev_dist_score': author_lev_dist_score, 'author_lev_sim_score': author_lev_sim_score, 'author_jaro_score': author_jaro_score, 'author_jaro_winkler_score':author_jaro_winkler_score, 'author_needleman_wunsch_score':author_needleman_wunsch_score, 'author_smith_waterman_score':author_smith_waterman_score, 'author_jaccard_score':author_jaccard_score, 'author_cosine_score':author_cosine_score, 'author_overlap_coeff_score': author_overlap_coeff_score, 'author_dice_score': author_dice_score, 'author_monge_elkan_score':author_monge_elkan_score, 'publisher_affine_score': publisher_affine_score, 'publisher_lev_dist_score': publisher_lev_dist_score, 'publisher_lev_sim_score': publisher_lev_sim_score, 'publisher_jaro_score': publisher_jaro_score, 'publisher_jaro_winkler_score': publisher_jaro_winkler_score, 'publisher_needleman_wunsch_score': publisher_needleman_wunsch_score,  'publisher_jaccard_score':publisher_jaccard_score, 'publisher_cosine_score':publisher_cosine_score, 'publisher_overlap_coeff_score':publisher_overlap_coeff_score, 'publisher_dice_score':publisher_dice_score, 'publisher_monge_elkan_score': publisher_monge_elkan_score, 'year_rel_diff': year_rel_diff, 'year_abs_norm': year_abs_norm, 'month_rel_diff': month_rel_diff, 'month_abs_norm':month_abs_norm, 'pages_rel_diff': pages_rel_diff, 'pages_abs_norm': pages_abs_norm         })
